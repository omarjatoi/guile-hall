;; hall/workarounds.scm --- workarounds implementation    -*- coding: utf-8 -*-
;;
...
(define (guile-m4-file)
  "Return a tweaked m4/guile.m4 file, which handles a problem whereby
guile-tools are installed without suffix in, e.g., Ubuntu.

This should be fixed upstream.  A patch by Aleix Conchillo Flaqué was
submitted at
